              ...
              onTap: () {
                Navigator.of(context).push(new MaterialPageRoute(
                  builder: (BuildContext context) => DetailAkun(
                    accountName: "Putu Sayu Indah Dian Rahayu",
                    accountEmail: "sayu.indah@undiksha.ac.id",
                    backgroundImage: "akun.jpg",
                  ),
                ));
              },
              child: UserAccountsDrawerHeader(
                accountName: new Text("Putu Sayu Indah Dian Rahayu"),
                accountEmail: new Text("sayu.indah@undiksha.ac.id"),
                currentAccountPicture: new GestureDetector(
                  onTap: () {},
                  child: new CircleAvatar(
                    backgroundImage: AssetImage('assets/appimages/akun.jpg'),
                  ),
                ),
